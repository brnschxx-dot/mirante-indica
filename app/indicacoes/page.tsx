              ...
              <div key={item.id} className="bg-white rounded-[2.5rem] p-8 shadow-sm border border-slate-100 flex flex-col relative overflow-hidden group">
                ...
                <div className="flex justify-between items-center gap-4">
                  ...
                  <a 
                    ...
                    className={`w-14 h-14 flex items-center justify-center rounded-full shadow-lg text-white transition-all active:scale-90 bg-emerald-500 shadow-emerald-100 ${!item.telefone && 'opacity-40 cursor-not-allowed'}`}
                  >
                  ...
                  <a 
                    ...
                    className={`w-14 h-14 flex items-center justify-center rounded-full shadow-lg text-white transition-all active:scale-90 bg-gradient-to-tr from-[#f9ce34] via-[#ee2a7b] to-[#6228d7] shadow-pink-100 ${!item.instagram && 'opacity-40 cursor-not-allowed'}`}
                  >
                  ...
                  {/* Maps - Gradiente Multi-color 2026 */}
                  <a 
                    ...
                    className={`w-14 h-14 flex items-center justify-center rounded-full shadow-lg text-white transition-all active:scale-90 bg-gradient-to-br from-[#4285F4] via-[#34A853] via-[#FBBC04] to-[#EA4335] shadow-blue-100 ${!item.endereco && 'opacity-40 cursor-not-allowed'}`}
                  >
                    <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
