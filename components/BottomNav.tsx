...
export default function BottomNav() {
  ...
  return (
    <div className="fixed bottom-0 left-0 w-full bg-white border-t border-gray-100 py-3 z-50">
      {/* Container centralizado flexível para acomodar os ícones */}
      <div className="flex justify-between items-center max-w-md mx-auto px-4 sm:px-6">
        ...
        <Link href="/lupa" className={`flex flex-col items-center gap-1 transition-colors ${pathname === '/lupa' ? 'text-blue-600' : 'text-gray-400'}`}>
          <Search size={22} />
